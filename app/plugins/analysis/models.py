...
class AnalysisTable(db.Model):
    ...
    # analysis_category = db.Column(db.String(128), db.ForeignKey('task_category.task_category_name'))
    # business_level_awareness = db.Column(db.String(128), db.ForeignKey('groups.group_name'))
